...
class PrecinctMap {
    ...
    getBBox() {
        return [-97.98706054687501, 29.744109309616512, -98.97583007812501, 29.090976994322702];
    }
    ...
    setFillOpacity(props) {
        if (props.Winner === 'Tie') {
            ...
            const share = props[props.Winner] / props['Total votes'];
            if (share < 0.16) {
                return 0.1;
            } else if (share === 1) {
                return 0.9;
    ...
    getCandidates() {
        return ['Velasquez','Nirenberg','Pina','Idrogo','Brockhouse','Atwood','Castanuela','Cecconi','Diaz'];
    }
