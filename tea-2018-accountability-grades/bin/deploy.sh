...
aws s3 sync --acl public-read --profile graphicBuilder --exclude '*.html' --exclude '*.js' --exclude '*.css' --exclude 'app/dev_assets' dist s3://$GRAPHIC_S3_BUCKET/graphics/$PROJECT_SLUG/
